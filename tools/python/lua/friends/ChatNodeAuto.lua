...
function ChatNode:initView()
    self.__LAYER_NAME = 'friends.ChatNode';
    local localParams = {};
	...
	localParams[1]:setBackGroundColorOpacity(247);
	...
	localParams[1]:setPosition(10.0, 0.0);
	self.__children['Panel_1'] = localParams[1];
	localParams[1].__children = self.__children;
	localParams[1].__Name = 'Panel_1';
	...
	self.__children['Panel_1#time_txt'] = localParams[2];
	localParams[2].__children = self.__children;
	localParams[2].__Name = 'Panel_1#time_txt';
	...
	localParams[3]:setPosition(50.0, 46.0);
	self.__children['Panel_1#icon'] = localParams[3];
	localParams[3].__children = self.__children;
	localParams[3].__Name = 'Panel_1#icon';
	...
	self.__children['Panel_1#icon#iconUnder'] = localParams[4];
	localParams[4].__children = self.__children;
	localParams[4].__Name = 'Panel_1#icon#iconUnder';
	...
	self.__children['Panel_1#icon#level'] = localParams[5];
	localParams[5].__children = self.__children;
	localParams[5].__Name = 'Panel_1#icon#level';
	...
	localParams[6]:setPosition(110.0, 92.0);
	self.__children['Panel_1#name'] = localParams[6];
	localParams[6].__children = self.__children;
	localParams[6].__Name = 'Panel_1#name';
	...
	self.__children['Panel_1#under'] = localParams[7];
	localParams[7].__children = self.__children;
	localParams[7].__Name = 'Panel_1#under';
	localParams[1]:addChild(localParams[7]);

	localParams[8] = ImageView:create('uires/public/sheet_bgframe/bgFrame0133.png', 1);
	localParams[8]:setAnchorPoint(0.50, 0.50);
	localParams[8]:setContentSize({width = 14.0, height = 12.0});
	localParams[8]:setPosition(109.5, 49.12);
	self.__children['Panel_1#Sprite_25'] = localParams[8];
	localParams[8].__children = self.__children;
	localParams[8].__Name = 'Panel_1#Sprite_25';
	localParams[1]:addChild(localParams[8]);

	localParams[9] = Text:create();
	localParams[9]:setFontSize(20);
	localParams[9]:setString([[]]);
	localParams[9]:setAnchorPoint(0.00, 1.00);
	localParams[9]:setContentSize({width = 0.0, height = 0.0});
	localParams[9]:setPosition(125.0, 52.39);
	self.__children['Panel_1#Text'] = localParams[9];
	localParams[9].__children = self.__children;
	localParams[9].__Name = 'Panel_1#Text';
	...
	localParams[10]:setBackGroundColorOpacity(224);
	...
	self.__children['Panel_2'] = localParams[10];
	localParams[10].__children = self.__children;
	localParams[10].__Name = 'Panel_2';
	...
	self.__children['Panel_2#time_txt'] = localParams[11];
	localParams[11].__children = self.__children;
	localParams[11].__Name = 'Panel_2#time_txt';
	localParams[10]:addChild(localParams[11]);

	localParams[12] = ImageView:create('uires/public/sheet_other/other0195.png', 1);
	...
	localParams[12]:setPosition(450.0, 46.0);
	self.__children['Panel_2#icon'] = localParams[12];
	localParams[12].__children = self.__children;
	localParams[12].__Name = 'Panel_2#icon';
	...
	self.__children['Panel_2#icon#iconUnder'] = localParams[13];
	localParams[13].__children = self.__children;
	localParams[13].__Name = 'Panel_2#icon#iconUnder';
	...
	self.__children['Panel_2#icon#level'] = localParams[14];
	localParams[14].__children = self.__children;
	localParams[14].__Name = 'Panel_2#icon#level';
	...
	localParams[15]:setPosition(390.0, 80.0);
	self.__children['Panel_2#name'] = localParams[15];
	localParams[15].__children = self.__children;
	localParams[15].__Name = 'Panel_2#name';
	...
	self.__children['Panel_2#under'] = localParams[16];
	localParams[16].__children = self.__children;
	localParams[16].__Name = 'Panel_2#under';
	...
	localParams[17]:setPosition(383.3, 49.12);
	self.__children['Panel_2#Sprite_25'] = localParams[17];
	localParams[17].__children = self.__children;
	localParams[17].__Name = 'Panel_2#Sprite_25';
	localParams[10]:addChild(localParams[17]);

	localParams[18] = Text:create();
	localParams[18]:setFontSize(20);
	localParams[18]:setString([[]]);
	localParams[18]:setAnchorPoint(1.00, 1.00);
	localParams[18]:setContentSize({width = 0.0, height = 0.0});
	localParams[18]:setPosition(368.91, 52.39);
	self.__children['Panel_2#Text'] = localParams[18];
	localParams[18].__children = self.__children;
	localParams[18].__Name = 'Panel_2#Text';
